...
import com.dt.springcloud.lb.LoadBalancer;
...
public class OrderController {
    ...
    /**
     * 此处应改为微服务名称，这样每次访问都去eureka中去拿地址，就会轮询拿，达到负载均衡效果
     */
    ...
    @Autowired
    private LoadBalancer loadBalancer;//自定义的轮询算法接口
    ...
    public CommonResult<Payment> getPayment2(@PathVariable("id") Long id) {
        ...
        if (entity.getStatusCode().is2xxSuccessful()) {
            ...
            return new CommonResult<>(444, "请求信息错误");
        }
    }
